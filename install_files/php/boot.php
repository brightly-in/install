...
define('BRIGHTLY_MINIMUM_PHP_VERSION_ID', 70008);
 ...
 * Check PHP version
 */
if (PHP_VERSION_ID < BRIGHTLY_MINIMUM_PHP_VERSION_ID) exit('You need at least PHP 7.0 to install brightly.in.');

/*
 * Check for JSON extension
 */
if (!function_exists('json_decode')) exit('JSON PHP Extension is required to install brightly.in');
...
define('BRIGHTLY_GATEWAY', 'http://gateway.octobercms.com/api');
